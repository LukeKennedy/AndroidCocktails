...
public class CategoryItemFragment extends DialogFragment implements
		OnItemClickListener {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		dialog.setContentView(inflater.inflate(R.layout.list_view_items, null));
	...
	public void onItemClick(AdapterView<?> parent, View view, int pos, long id) {
		...
		int drinkId = mCursor.getInt(mCursor
				.getColumnIndex(DBHelper.colDrinkID));
		Intent drinkRecipeIntent = new Intent(getActivity(),
